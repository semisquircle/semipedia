...
This privacy policy applies to the Pluto Timer Lite app (hereby referred to as "Application") for mobile devices that was created by Semi Squircle (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
